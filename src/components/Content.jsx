...
function Content() {
  return (
    <div>
        <div className="main">
            <h1>Your New Gateway to<br></br> Exclusive Investment In <br></br>Best Opportunities</h1>
        </div>
        <div className="main1">
          <p>Believe that knowledge is key to confident decesion making that's why we provide clients with the wealth of educational resources market insights,and timely updates.</p>
        </div>
    ...
    <div className="container">
        <img src="https://assets-global.website-files.com/65b8d5c5e2ef493dbe7c1b86/65b8f585cd44c52b3679a41c_v1%20banner%20img-p-800.png" alt="Responsive Image" class="responsive-image"/>
    </div>
    <section className="write-content">
    <div className="Content">
            <h1>Trusted By 40K+ Brands<br></br>All Over The World</h1>
        </div>
        ...
        <div class="logos">
            ...
            <img src="https://assets-global.website-files.com/65b8d5c5e2ef493dbe7c1b86/65b90a0556340cfea41a9678_company%20logo%204.svg" alt="Logo 4"/>
            <img src="https://assets-global.website-files.com/65b8d5c5e2ef493dbe7c1b86/65b909f6c024b60878afb81e_company%20logo%203.svg" alt="Logo 4"/>
